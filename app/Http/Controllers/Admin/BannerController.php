...
class BannerController extends Controller
{
    ...
    public function index()
    {
        ...
        $columnPrefs = ColumnPreference::where('admin_id', Auth::guard('admin')->id())
          ...
          $bannersSaveOrder = $columnPrefs ? json_decode($columnPrefs->column_order, true) : null;
    ...
    public function edit(string $id)
    {
        ...
        if (!$banner) {
            return redirect()->route('banners.index')->with('error_message', 'Banner not found');
        }
        return view('admin.banners.add_edit_banner', compact('title', 'banner'));
    }
