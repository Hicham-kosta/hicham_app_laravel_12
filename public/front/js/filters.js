$(document).ready(function() {
    ...
    //Handle price range filter (if you add min-max price inputs later)
...
// Ajax call for filtered products
   ...
   if(history.pushState){
    ...
    $(".filterAjax").click(function () {
        ...
        if (name === "price" && $(document).fi$(this).nd('.inlineFilterLink[id*="RemoveFilter-"][data-name="price"]').length > 0) {
