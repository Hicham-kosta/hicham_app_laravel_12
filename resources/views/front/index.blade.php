 ...
 <!-- Carousel Start -->
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            @foreach($homeSliderBanners as $key => $sliderBanner)
                <div class="carousel-item @if($key == 0) active @endif" style="height: 710px;">
                    <a href="{{$sliderBanner['link']}}" title="{{$sliderBanner['title']}}">
                     <img class="img-fluid" src="{{ asset('front/images/banners/' . 
                    $sliderBanner['image']) }}" alt="{{$sliderBanner['alt']}}">
                    </a>
                </div>
            @endforeach      
        </div>
            ...
            <div class="col-lg-3 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="{{url('category/' . $category['url'])}}" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="{{$image}}" alt="{{$category['name']}}"></a>
    ...
    <!-- Offer Start -->
     @if(count($homeFixedBanners) > 0)
    <div class="container-fluid offer pt-2">
        <div class="row px-xl-5">
            @foreach($homeFixedBanners as $fixBanner)
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-4 px-4" style="background-image: url('{{ asset('front/images/banners/' . $fixBanner['image']) }}'); background-size: cover;">
