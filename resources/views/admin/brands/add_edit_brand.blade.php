                  ...
                  @if(isset($brand)) @method('PUT') @endif
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <br />
                          <div class="mb-2">
                            <img src="{{asset('front/images/brands/'.
                            $brand->image)}}" width="50" alt="Brand Image"/>
                          </div>  
                        @endif
                      </div>
                      <div class="mb-3">
                        ...
                        <br />
                          <div class="mb-2">
                            <img src="{{asset('front/images/logos/'.
                          $brand->logo)}}" width="50" alt="logo"/>
                          </div>  
                        @endif
                      </div>
                      <div class="mb-3">
                        ...
                        placeholder="Enter Brand Discount" value="{{old('brand_discount', $brand->discount ?? '')}}">
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="url">Brand URL*</label>
                        <input type="text" class="form-control" id="url" name="url"
                        placeholder="Enter Brand URL" value="{{old('url', $brand->url ?? '')}}">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        placeholder="Enter Meta Title" value="{{old('meta_title', $brand->meta_title ?? '')}}" >
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="meta_description">Meta Description</label>
                        <input type="text" class="form-control" id="meta_description" name="meta_description"
                        placeholder="Enter Meta Description" value="{{old('meta_description', $brand->meta_description ?? '')}}" >
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="meta_keywords">Meta Keywords</label>
                        <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                        placeholder="Enter Meta Keywords" value="{{old('category_meta_keywords', $brand->meta_keywords ?? '')}}" >
                      </div>
